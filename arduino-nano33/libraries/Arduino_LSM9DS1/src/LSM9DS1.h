...
class LSM9DS1Class {
  public:
    ...
    virtual int readAcceleration(int16_t& x, int16_t& y, int16_t& z);
    ...
    virtual int readGyroscope(int16_t& x, int16_t& y, int16_t& z);
    ...
    virtual int readMagneticField(int16_t& x, int16_t& y, int16_t& z);
